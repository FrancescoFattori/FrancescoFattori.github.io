var htmlResizer = document.getElementById("resizer"); var htmlSideDiv = document.getElementById("sideDiv"); htmlSideDiv.active = true; var htmlGraphDiv = document.getElementById("graphDiv");
        ...
        var gl = canvas.getContext("webgl2",{antialias:true}); if (!gl) { throw new Error("WebGL not supported!"); }
        window.onresize = () => {
        ...
        function setupWebGL() {
            ...
            buildRaymarchShader("(pow(x,4.00000000))+(pow(y,4.00000000))+(pow(z,4.00000000))+(-((5.00000000)*(((pow(x,2.00000000))*(pow(y,2.00000000)))+((pow(y,2.00000000))*(pow(z,2.00000000)))+((pow(x,2.00000000))*(pow(z,2.00000000))))))+((56.00000000)*(x)*(y)*(z))+(-((20.00000000)*((pow(x,2.00000000))+(pow(y,2.00000000))+(pow(z,2.00000000)))))+(16.00000000)");
        }
